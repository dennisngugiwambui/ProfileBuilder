            ...
            <div class="right">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="input-field">
                        ...
                        <input type="email" placeholder="enter email" id="email" name="email" class="@error('email') is-invalid @enderror" value="{{ old('email') }}" required autocomplete="email" autofocus>
                        @error('email')
